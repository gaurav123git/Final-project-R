...
public class Premium {
	...
	@OneToMany(mappedBy = "premiumdetails_id")
	
	private List<Bill> billDetailsList;
	...
	public List<Bill> getBillDetailsList() {
		return billDetailsList;
	}
	public void setBillDetailsList(List<Bill> billDetailsList) {
